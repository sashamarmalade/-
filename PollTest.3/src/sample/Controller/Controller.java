...
public class Controller implements Initializable {
    ...
    private void StartQuestions(ActionEvent event) {
        ...
        for (Node Quest: NodeConstructQuestion(DQ))
            VBThemeQuestions.getChildren().add(Quest);
    ...
    private ArrayList<Node> NodeConstructQuestion(ArrayList<DataQuestion> AllDQ){
        ...
        for (DataQuestion DQ : AllDQ) {
            ...
            switch (DQ.getType()) {
                ...
                case several_possible -> System.out.println();
                case completion_of_sentences -> System.out.println();
                case establishing_relationships -> System.out.println();
            }
