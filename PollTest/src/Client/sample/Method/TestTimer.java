...
import DataTransfer.ThemeConstructor;
import javafx.application.Platform;
import javafx.event.ActionEvent;
import javafx.scene.control.Label;
import org.joda.time.DateTime;
import Client.sample.Controller.Controller;
...
public class TestTimer implements Runnable {
    ...
    public TestTimer(Time time, Label LabelTime, Controller c, ThemeConstructor DT, ArrayList<Object> Result, ActionEvent event){
