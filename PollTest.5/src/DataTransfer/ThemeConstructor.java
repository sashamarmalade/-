...
public class ThemeConstructor implements Serializable{
    ...
    public ThemeConstructor(int ID, String TextTheme, String Type, Time Time, int NumberAttempts){
        this.ID = ID;
    ...
    public ThemeConstructor(int ID, String TextTheme, String Type, Time Time, int NumberAttempts, int AttemptsLeft){
        this.ID = ID;
        this.TextTheme = TextTheme;
        this.Type = Type;
        this.Time = Time;
